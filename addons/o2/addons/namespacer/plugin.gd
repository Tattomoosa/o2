...
func _get_index_content(dir: String, entries: Array, _is_root := false) -> String:
	var lines := PackedStringArray([TOP_INDEX_LINE])
	# TODO class_name should be configurable per-namespace
	# I mostly don't want it!
	# if is_root:
