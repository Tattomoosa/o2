...
func _parse_end(object: Object) -> void:
	...
	var add_btn := create_metadata_script_popup_button(object)
	var extend_btn := create_metadata_script_extend_button()
	...
	hbox.add_child(extend_btn)

func create_metadata_script_extend_button() -> Button:
	var btn := Button.new()
	...
	btn.add_child(dialog)
	btn.pressed.connect(dialog.popup_centered)
	return btn
